        ...
        <Table striped bordered hover>
          ...
          <tbody>
            {cartProductVall.map((cartProduct) => {
              ...
              cartProductsIds.forEach(
                (val) => (count[val] = (count[val] || 0) + 1)
              );
              return (
                <tr key={Math.random()}>
                  ...
                  <td className="text-center">
                    {FormaterPrice(Math.ceil(cartProduct.price))}
                  </td>
          ...
          <tfoot>
            <tr>
              ...
              {/* <th></th> */}
              <th></th>
              <th className="text-center">{FormaterPrice(itemsPrice)}</th>
              <th></th>
              <th className="w-16">
                <Button
                  onClick={() => {
                  ...
                  variant="danger"
                >
                  Clear All({cartProductVall.length})
                </Button>
              </th>
            </tr>
          </tfoot>
