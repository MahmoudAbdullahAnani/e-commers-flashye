      ...
      <>
        <Container className="my-5 d-flex align-items-center cartContainer">
          <motion.div
            ...
            className="row  w-full m-auto  my-2 border-2 border-zinc-600 p-10 rounded-tl-3xl rounded-br-3xl"
          >
            <div className="viowImage col-xs-9 overflow-hidden col-md-6">
              <img
                src={onlyProduct.image}
                className="w-50 m-auto "
                alt={onlyProduct.title}
              />
            </div>
            <div className="ditels d-flex flex-col col-xs-9 col-md-6">
              ...
              <Button
                ...
                className="w-100 rounded-lg text-white bg-slate-700"
              >
                Add Cart
              </Button>
            </div>
